...
class LoginHandler:
    ...
    def __init__(self, mongo_db: MongoDBConnect, bcrypt: Bcrypt):
    ...
    def check_password(self, username: str, password: str):
        ...
        if check_password is not None and self.bcrypt.check_password_hash(check_password['password'], password) is True:
            return True
        else:
            return False
